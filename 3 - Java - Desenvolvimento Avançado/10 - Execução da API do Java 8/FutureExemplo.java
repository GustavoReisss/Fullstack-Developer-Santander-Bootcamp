...
public class FutureExemplo {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        while(true){
            int numDeAtividadesNaoFinalizas = 0;
            for(Future<?> futuro : futuros) {
                if(futuro.isDone()){
                    ...
                    numDeAtividadesNaoFinalizas++;
                }
            }
            if(futuros.stream().allMatch(Future::isDone)){
                break;
            }
            System.out.println("Número de atividades não finalizas: " + numDeAtividadesNaoFinalizas);
            Thread.sleep(500);
        }
...
class Quarto extends Comodo {
    ...
    private String arrumarGuardaRoupa() throws InterruptedException{
        Thread.sleep(5000);
        String atividade = "arrumar o guarda roupa";
    ...
    private String varrerOQuarto() throws InterruptedException {
        Thread.sleep(7000);
        String atividade = "varrer o quarto";
        System.out.println(atividade);
        return atividade;
    }
    ...
    private String arrumarACama() throws InterruptedException {
        Thread.sleep(10000);
        String atividade = "arrumar a cama";
        System.out.println(atividade);
        return atividade;
    }  
}
